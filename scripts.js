...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('%c👋 Welcome to Kriza Ann Estanislao\'s Portfolio!', 'color: #3498db; font-size: 16px; font-weight: bold;');
    console.log('%cBuilt with ❤️ for professional content editing services', 'color: #7f8c8d; font-size: 12px;');
});
